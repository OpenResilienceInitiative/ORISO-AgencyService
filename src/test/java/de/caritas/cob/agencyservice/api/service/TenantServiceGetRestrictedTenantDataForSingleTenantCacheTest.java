...
@SpringBootTest(
    classes = {
      TenantService.class,
      TenantServiceGetRestrictedTenantDataForSingleTenantCacheTest.CacheTestConfig.class
    },
...
class TenantServiceGetRestrictedTenantDataForSingleTenantCacheTest {
  ...
  @Test
  void getRestrictedTenantDataForSingleTenant_shouldCacheResult() {
